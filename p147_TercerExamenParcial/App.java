...
public class App extends JFrame implements ActionListener {
    ...
    JLabel lblDatos, lblNombre, lblEdad, lblSexo, lblEstado, lblDescripcion, lblSalario;
    JTextField txtNombre,txtEdad ,txtSexo ,txtEstado, txtDescripcion, txtSalario;
    JFileChooser fchArchivo;
    JButton btnAgregar, btnGrabar;

    public App() {
        super("Procesa datos de   Jugador");
    ...
    public void mostrarDatos(int ren) {
        ...
        txtEstado.setText(datos.get(ren).getEstadoCivil());
    ...
    public void guardarCampos() {
        ...
        est.setEstadoCivil( txtEstado.getText() );
