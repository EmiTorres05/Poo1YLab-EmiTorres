...
public class p38_AceptarEstudianteV2 {
    public static void main(String[] args) {
        ...
        System.out.println("Universidad Kitty Kat S.A DE C.V\nSistema de Admision\n");
        ...
        switch (sexo) {
            case 'H': System.out.print("Lo sentimos la escuela solo admite a mujeres..."); break;
            case 'M': System.out.print("Introduce tu edad:"); edad = obj.nextInt();
            if (edad < 21) { System.out.println("Lo sentimos la escuela solo acepta a mayores de 21...");}
                ...
                c3 = obj.nextFloat();
                prom = ((c1 + c2 + c3)/3);
                if (prom >= 8){ System.out.println("¡Felicidades " + nombre + " has sido aceptada para la universidad con tu promedio de "+ prom + "!" );}
